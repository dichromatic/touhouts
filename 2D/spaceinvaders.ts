...
// functions to manipulate state and entities
        ...
        tick = (s:State, elapsed:number) => {
            ...
            return s.garbageClean ? s = initialState: // if garbage needs cleaning to reset, then set the state to initialstate
...
// final state reducers
        ...
        // reducing states
        reduceState = (s:State, e:Shoot|Translate|Thrust|Tick|Reset)=>
